...
export default function Home( { data } ) {
  ...
  return (
    <div className={styles.body}>
      <Head>
        <title>Levi | Portfolio</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/logo.svg" />
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com"/>
        <link href="https://fonts.googleapis.com/css2?family=Bungee+Shade&family=Noto+Sans:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet"></link>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerItems}>
          ...
          <nav className={styles.navBar}>
            <Link href='/about' className={styles.navItems}>Sobre mim</Link>
            <Link href='/projects' className={styles.navItems}>Projetos</Link>
          </nav>
        </div>
      </header>
      <main className={styles.main}>
        <section className={styles.profile}>
          <Image 
            ...
            height={73}
            width={73}
            alt='A profile picture by the owner of this web site'
          ...
          {data? 
            <>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" width="28" height="28"><path fillRule="evenodd" className={styles.star} d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" fill={`${data.color}`}></path></svg>
        ...
        <section className={styles.socialMedia}>
          <div className={styles.contentContainer}>
            <Link href='https://www.linkedin.com/in/vitor-romão-739022230/' target='_blank' rel="noopener noreferrer" className={styles.media}>
        ...
        <section className={styles.aboutMe}>
          <div className={styles.description}>
            <h3>Sobre mim</h3>
            <p>
              Olá, sou um Desenvolvedor web com experiência em programação front-end e back-end, atualmente, possuo habilidade em Node, Next, entre outras tecnologias presentes no
              mercado na atualidade, mongoDB, FireBase, Web Socket e Json Web Token. Apaixonado por resolver problemas complexos e desenvolver 
              soluções inovadoras para melhorar a experiência do usuário, estou constantemente à procura de oportunidades para aprender e crescer profissionalmente.
            </p>
          </div>
        </section>
              ...
              <ul>
                ...
                <li>
                  <Link href='https://clone-filmes-vitor.vercel.app/' target='_blank'>
                    ...
                    <p>Um aplicativo simulando a Netflix, contendo filmes em lançamento e que irão ser lançados. Feita em React, consumindo uma API do TMDB movies. Você precisa se cadastrar no site e fazer Login para utilizar...</p>
                  </Link>
                </li>
                <li>
